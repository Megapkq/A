...
if __name__ == "__main__":
    ...
    def start_grabbing():
        ...
        if ret != 0:
            tkinter.messagebox.showerror('show error', 'start grabbing fail! ret = ')
            return
    ...
    picture=tk.Frame(window,bg='white')
    picture.place(x=300,y=20)
    Image_video=tk.Label(picture)
    Image_video.place(x=330,y=30)
